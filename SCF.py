...
\033[1;97msimple tools spam komentar posts facebook
...
def menu():
	...
	print ("")
	print ("\033[1;97m(1) spam coment posts facebook ")
	...
	if pahrul =="1":
		...
		print("\033[1;97m(+) ngetik apaan lu kambing !!!")
		exit()
...
def komen():
	...
	os.system("clear")
	print(logo)
	id = input(f"\033[1;97m(+) id postingan : ")
	komen = input("\033[1;97m(+) komentar : ")
